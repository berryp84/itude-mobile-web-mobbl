...
@Named("GetPolytones")
public class GetPolytones extends GenericAction 
{
	...
	public MBOutcome execute(MBDocument document, String path, String outcomeName) 
	{
	    ...
	    MBDocument responseDoc = loadDocument("polytones", requestDoc);
	    MCDSUtilities.setPositions(responseDoc, "polytone", 0+((index-1)*20));
	    
	    MBOutcome outcome = new MBOutcome("OUTCOME-page_polytones", responseDoc);
